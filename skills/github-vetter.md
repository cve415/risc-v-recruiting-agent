# SKILL: Technical Implementation Vetting
**Version:** 1.0 (Public)
...
- **Instruction Set Depth:** Evaluates the ability to identify specific extensions and custom instruction implementations within open-source cores.
